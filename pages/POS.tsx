...
export default function POS() {
  ...
  const handleSendToKitchen = async () => {
      ...
      try {
          ...
          db.logActivity({ storeId: currentStoreId, userId: user.id, userName: user.name, action: 'ORDER_UPDATE', description: `Order #${added.orderNumber} saved/updated` });
  ...
  const renderDetailView = () => (
    <div className="flex flex-col h-full bg-gray-50 dark:bg-gray-950 p-4 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
      {/* Top Bar: Ticket #, Search, and Options */}
